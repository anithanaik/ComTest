...
namespace Commons_Automation
{
    public class CommonsGroups:MainSetup
    {
      ...
      //  UserInfo UserInfo;
        ...
        [FindsBy(How = How.XPath, Using = "//select[@id='asc_proofreader_cost_options']/option[2]")]
       ...
       #region Join and Open Group
        ...
        public void OpenJoinedGroup_SetStewardRole(string groupName)
        {
            ...
            test.Log(test.Status, userInfo.userName.Text);
            filterMembers.Click();
        ...
        public void EditCostAndDuration()
        {
            ...
            Thread.Sleep(2000);
            EditASCCost.Clear();
            EditASCCost.SendKeys("35.00");


            EditASCDuration.Clear();
            EditASCDuration.SendKeys("42.00");
            ...
            {
                if (GetASCCostAndDurationRows[i].Text.Contains("35.00"))
                {
